...
Die Ergebnisse dieses \acl{RF} mit reduzierter Merkmalsanzahl können mit dem in \ref{res-statistical} untersuchten \acl{RF} verglichen werden.

 \begin{figure}[H]
 	\centering
  	\begin{tabular}{l || c | c | c}
 									& insgesamt 		& RF mit 13 Merkmalen			& RF mit reduzierter Merkmalszeit\\\hline
 		$E\textsubscript{HR} < 5$ 		& 32{,}61\,\% 	& 17,35\,\%		& 16,07\,\%	\\
 		$E\textsubscript{HR} < 10$ 		& 43{,}22\,\% 	& 22,20\,\% 		& 20,82\,\%	\\
 		$E\textsubscript{HR} < 15$ 		& 51{,}66\,\% 	& 25,92\,\% 		& 24,34\,\%	\\
 		$E\textsubscript{HR} < 20$ 		& 59{,}40\,\% 	& 29,23\,\% 		& 27,45\,\%\\
 		MAE								& 21{,}85		& 	&\\
 		Coverage						& 43{,22}\,\%	&	&\\
 		Accuracy auf Testset				& -				&	&\\
 		Accuracy der Kreuzvalidierung 	& -				&	&\\
 	\end{tabular}
