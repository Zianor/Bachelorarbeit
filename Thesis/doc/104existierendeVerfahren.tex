...
\begin{figure}[H]
	...
	\caption[Verteilung von $E\textsubscript{HR}$ auf dem Testset]{Verteilung von $E\textsubscript{HR}$ auf dem Testset}
 ...
 \begin{figure}[H]
 	\centering
  	\begin{tabular}{l || c | c | c}
 		...
 		$E\textsubscript{HR} < 5$ 	&  32{,}61\,\% 	& 18,32\,\% 					& 8,29\,\%	\\
 		$E\textsubscript{HR} < 10$ 	&  43{,}21\,\% 	& 21,34\,\% 					& 8,89\,\%	\\
 		$E\textsubscript{HR} < 15$ 	&  51{,}64\,\% 	& 23,35\,\% 					& 9,22\,\%	\\
 		$E\textsubscript{HR} < 20$ 	&  59{,}38\,\% 	& 25,12\,\% 					& 9,47\,\%\\
 	\end{tabular}
 ...
 \begin{figure}[H]
 	\centering
  	\begin{tabular}{l || c | c | c}
 		...
 		$E\textsubscript{HR} < 5$ 		& 32{,}61\,\% 	& 17,35\,\%		& 28,00\,\%	\\
 		$E\textsubscript{HR} < 10$ 		& 43{,}22\,\% 	& 22,20\,\% 		& 36,25\,\%	\\
 		$E\textsubscript{HR} < 15$ 		& 51{,}66\,\% 	& 25,92\,\% 		& 42,53\,\%	\\
 		$E\textsubscript{HR} < 20$ 		& 59{,}40\,\% 	& 29,23\,\% 		& 48,25\,\%\\
 		MAE								& 21{,}85		& 17,66			& 19{,}49\\
 		Coverage						& 43{,22}\,\%	& 44,20\,\%		& 77{,}08\,\%\\
 		Accuracy (Testset)				& -				& 0,57			& 0,52\\
