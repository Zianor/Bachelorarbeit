...
In Abbildung \ref{fig:brueser-sqi-MAE-Coverage} wird sichtbar, dass die Wahl der Schwellwerte großen Einfluss auf das Ergebnis hat und in jedem Fall Genauigkeit gegen Coverage eingetauscht wird. Auch ist deutlich, dass die Accuracy der Klassifikation mit mit Werten knapp über 0{,}6 nicht gut ist. Des Weiteren ist die Coverage bei verhältnismäßig kleineren \ac{MAE} sehr niedrig ist.
  ...
  \begin{figure}[H]
 	...
 	\begin{tabular}{l || c | c | c}
 		...
 		insgesamt 					& 20{,}18	& -				& \\
 		annotiert					& 3{,}18		& 43{,}22\,\%	& \\ \hline
 		$q_{th}=0{,}4, c_{th}=50$	& 11{,}59	& 20{,}95\,\%	& 0{,}65\\
 		$q_{th}=0{,}4, c_{th}=75$	& 9{,}33		& 11{,}78\,\%	& 0{,}63\\
 		$q_{th}=0{,}4, c_{th}=100$	& 8{,}69		& 5{,}26\,\%		& 0{,}60\\ \hline
 		$q_{th}=0{,}3, c_{th}=50$	& 20{,}12	& 58{,}73\,\%	& 0{,}55\\
 		$q_{th}=0{,}3, c_{th}=75$	& 17{,}10	& 37{,}87\,\%	& 0{,}62\\
 		$q_{th}=0{,}3, c_{th}=100$	& 13{,}05	& 19{,}25\,\%	& 0{,}63\\ \hline
 		$q_{th}=0{,}2, c_{th}=75$	& 20{,}29	& 96{,}43\,\%	& 0{,}44\\
 	\end{tabular}
 ...
 Die detailliertere Evaluation wird die Schwellwerte $q_{th} = 0.4$ und $q_{th}$ mit $c_{th}=75$ vorgestellt.
