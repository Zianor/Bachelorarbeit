...
\section{Messdaten}
	...
	% TODO E_HR auf maximal mögliche Abweichung gesetzt
	Wenn keine Herzrate auf dem \ac{BKG}-Signal ermittelt werden konnte, wird $E\textsubscript{HR}$ auf den maximalen Wert eines \textit{floats} gesetzt. Die Verteilung von $E\textsubscript{HR}$, abgebildet in \ref{fig:class-histo}, zeigt, dass Segmente mit Fehlern von mehr als 20\,\% und solche mit Fehlern unter 5\,\% jeweils die beiden größten Gruppen bilden. 
