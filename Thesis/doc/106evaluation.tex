...
Nachdem die generelle Performance der Modelle untersucht wurde, wird nun der Einfluss des verwendeten Schwellwertes $E\textsubscript{th}$ der Annotation untersucht. %Aufgrund des Rechenaufwands wurden für diese Modelle die Hyperparameter nicht optimiert, weshalb die Ergebnisse nur relativ zueinander zu betrachten sind.
...
\begin{table}[H]
	...
	Coverage annotiert [\%]		& -			& 43{,}21					& - 						& -		\\
 	...
 	\ac{MAE} [FE]				& 21{,}85	& -							& - 						& -		\\
 	F1-Score 					& -			& 36,51						& 0,61						& 0,75	\\%TODO: update numbers
 	AUC 						& -			& 41,99						& 0,64						& 0,74	\\%TODO: update numbers
 	\end{tabular}	
