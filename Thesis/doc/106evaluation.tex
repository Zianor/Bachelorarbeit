...
Bei der Betrachtung von Coverage und \ac{MAE} aller vier Modelle mit den verschiedenen Schwellwerten $E\textsubscript{th}$ im Vergleich zeigt sich, dass der Tradeoff zwischen Coverage und \ac{MAE} nahezu linear ist (Abbildung\,\ref{fig:threshold-variation}). %TODO: pls check
